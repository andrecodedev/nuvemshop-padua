...
{% endif %}
    ...
    {% endif %}
              ...
              <div class="js-cart-total-container js-visible-on-cart-filled mb-3" style="display:none; height: 0; opacity: 0" data-store="cart-total" >
              ...
              <div class="js-visible-on-cart-filled px-3" {% if cart.items_count == 0 %}style="display:none;"{% endif %}>
                ...
                <div>
                  ...
                  {% if cart_page %}
                    ...
                    {% if cart.checkout_enabled %}
                      <div class="row mb-3">
                        <input id="go-to-checkout" class="btn btn-primary btn-block" type="submit" name="go_to_checkout" value="FINALIZAR COMPRA" style="text-align: left;font-weight: 100;" />
                      </div>
                    {% else %}
                  ...
                  {% else %}
                    ...
                    <div class="js-ajax-cart-submit row mb-3 position-relative" {{ not cart.checkout_enabled ? 'style="display:none"' }} id="ajax-cart-submit-div" >
                      <input class="btn btn-primary btn-block" type="submit" name="go_to_checkout" value="FINALIZAR COMPRA" style="text-align: left;font-weight: 100;" data-component="cart.checkout-button" />
                      <span style="position: absolute;z-index: 12;right: 2%;color: #fff;top: 50%;transform: translateY(-50%);" class="js-cart-total {% if cart.free_shipping.cart_has_free_shipping %}js-free-shipping-achieved{% endif %} {% if cart.shipping_data.selected %}js-cart-saved-shipping{% endif %}" data-component="cart.total" data-component-value='{{ cart.total }}'>{{ cart.total | money }}</span>
                    </div>
                    <div class="row">
