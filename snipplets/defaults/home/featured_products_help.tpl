...
<section class="section-featured-home" data-store="{{ data_store }}">
	<div class="container">
		<div class="row js-products-{{ highlighted_products_setting_name }}-container" data-format="slider" data-desktop-columns="{% if settings.grid_columns == 2 %}4{% else %}3{% endif %}">
			...
			<div class="js-swiper-featured-demo-prev-{{ highlighted_products_setting_name }} js-swiper-{{ highlighted_products_setting_name }}-prev swiper-button-prev d-none d-md-flex svg-circle svg-circle-big svg-icon-text{% if settings.icons_solid %} svg-solid{% endif %}">
				<svg class="icon-inline icon-2x mr-1 icon-flip-horizontal"><use xlink:href="#chevron"/></svg>
			</div>
			<div class="js-swiper-featured-demo-next-{{ highlighted_products_setting_name }} js-swiper-{{ highlighted_products_setting_name }}-next swiper-button-next d-none d-md-flex svg-circle svg-circle-big svg-icon-text{% if settings.icons_solid %} svg-solid{% endif %}">
