        ...
        <div class="row align-items-center {% if not 'home_popup_image.jpg' | has_custom_image %}mt-3{% endif %}">
            {% if settings.home_popup_txt %}
                <div class="col-12">
                    ...
                    <a href="{{ settings.home_popup_url | setting_url }}">
                    {% endif %}
                    <h3 class="text-left mt-3 {% if not settings.home_news_box %}mb-0{% endif %}">{{ settings.home_popup_txt }}</h3>
                    {% if settings.home_popup_url %}
                    </a>
                    {% endif %}
                </div>
            ...
            {% if settings.home_news_box %}
                <div class="col-12 newsletter">
                    <div id="news-popup-form-container">
                        ...
                        <p class="infos-newsletter">Ao clicar em "Cadastrar" você autoriza receber nossa newsletter e concorda com as politicas de privacidade do nosso site.</p>
                    </div>
                </div>
            {% endif %}
        </div>
