...
Página de inicio
	...
	description
		description = <a target='_blank' href='/admin/themes/settings/product_order/'>Elegí cuáles vas a destacar</a>
	collapse
	...
	checkbox
		...
		description = Mostrar banner
	image
		show_if = banner_promotional_01_show
		original = banner_promotional_01.png
		title = Cargar imagen (JPG, GIF, PNG)
		width = 620
		height = 715
	i18n_input
	...
	i18n_input
		show_if = banner_promotional_01_show
		name = banner_promotional_01_top_title
		description = Título de cima em destaque
	i18n_input
		show_if = banner_promotional_01_show
	...
	image
		show_if = banner_promotional_01_show
		original = banner_promotional_logo_01.png
		title = Imamgem da logo (JPG, GIF, PNG)
		width = 97
		height = 130
...
Listado de productos
	meta
		...
		advanced = true
	title
		title = Imagem padrão para o topo da lista de produtos
	image
		title = Cargar imagen (JPG, GIF, PNG)
...
Detalle de producto
	...
	checkbox
		name = compare_price_saved_money
		description = Mostrar monto ahorrado en productos con precio promocional
	subtitle
		subtitle = <span class='legend'>No aplica si el precio con descuento por medio de pago está visible</span>
	title
	...
	subtitle
		subtitle = <span class='js-description-html'>Cuando un producto tenga variantes de 'Talle', podés mostrar un pop-up con las medidas. Solo necesitás <a target='_blank' href='/admin/pages/'>crear una página</a> e incluir su link debajo.</span>
	i18n_input
		name = size_guide_url
	...
	subtitle
		subtitle = Últimas unidades en stock
	checkbox
		name = last_product
		description = Mostrar un mensaje para incentivar la compra cuando queden pocas unidades
	text
		description = Mostrar cuando queden menos de:
		name = latest_products_available
		placeholder = Ej.: 10
	subtitle
		subtitle = <span class='legend'>Ingresá solamente números</span>
	i18n_input
		description = Mensaje cuando queda 1 unidad en stock
	...
	image
		original = product_informative_banner_01.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 50
		height = 50
	dropdown
	...
	checkbox
		...
		description = Mostrar información
	image
		original = product_informative_banner_02.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 50
		height = 50
	dropdown
	...
	checkbox
		...
		description = Mostrar información
	image
		original = product_informative_banner_03.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 50
		height = 50
	dropdown
	...
	subtitle
		subtitle = Es necesario si querés moderar los comentarios. Podés obtenerlo <a target='_blank' href='https://lookup-id.com/#'>acá</a>
...
Páginas Instucionais
	meta
		icon = copyright
		advanced = true
	subtitle
		subtitle = Selecione o menu que vai aparecer nas páginas institucionais.
	menu
		name = institu_menu
		description = Qual menu vai aparecer nas páginas institucionais?
	subtitle
		subtitle = Edite as seções das página de institucionais.
	collapse
		title = Página de sobre
	i18n_input
		name = about_page_01_url
		description = Página associada
	description
		description = Seções da página de sobre do site.
	subtitle
		subtitle = Primeira seção: Texto e Imagem
	image
		original = about.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 560
	...
	i18n_input
		...
		description = Descripción
	subtitle
		subtitle = Segunda seção: Banner horizontal - Imagem Desktop
	image
		original = about_banner.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 1152
		height = 316
	subtitle
		subtitle = Segunda seção: Banner horizontal - Imagem Mobile
	image
		original = about_banner_mobile.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 375
		height = 400
	subtitle
		subtitle = Terceira seção: Valores
	i18n_input
		name = values_title
		description = Título
	subtitle
	...
	i18n_input
		...
		description = Título
	image
		original = value_05.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 120
		height = 120
	subtitle
		subtitle = Quarta seção: Imagem e texto
	image
		original = about_image_last.jpg
		title = Cargar imagen (JPG, GIF, PNG)
		width = 560
		height = 645
	i18n_input
		name = about_image_last_title
		description = Título
	i18n_input
		name = about_image_last_description
		description = Descripción
	collapse
		title = Página de PRESS
	i18n_input
		name = press_page_02_url
		description = Página associada
	description
		description = Blocos da página de PRESS do site.
	gallery
		name = press
		gallery_image = Agregar imagen
		gallery_link = [Opcional] Página web a la que quieres que te lleve la imagen al hacer click
...
WhatsApp Flutuante
	...
	checkbox
		name = whatsapp_float
		description = Mostrar flutuante de WhatsApp
	i18n_input
		name = whatsapp_link
		description = Link
