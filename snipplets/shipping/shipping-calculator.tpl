...
<div class="shipping-block">
    <button class="collapse-button btn d-flex justify-content-start algin-items-center"  type="button">
		<p class='pl-2'>Confira o prazo de entrega</p>
    </button>
    <div class="collapse-content-shipping" style="display: none; margin-top: 10px;">
		...
		{% if product_detail %}
			...
			<div class="mb-2 col-12" data-store="shipping-calculator">
				...
				<div class="js-shipping-calculator-head shipping-calculator-head position-relative transition-soft {% if cart_zipcode %}with-zip{% else %}with-form{% endif %} {% if free_shipping_messages_visible %}with-free-shipping{% endif %}">
					<div class="js-shipping-calculator-with-zipcode {% if cart_zipcode %}js-cart-saved-zipcode transition-up-active{% endif %} mb-4 w-100 ">
					...
					<div
						...
						{% embed "snipplets/forms/form-input.tpl" with{type_tel: true, input_value: cart_zipcode, input_name: 'zipcode', input_custom_class: 'js-shipping-input w-100 ', input_placeholder: "Tu código postal" | translate, input_aria_label: 'Tu código postal' | translate, input_label: false, input_append_content: true, input_group_custom_class: 'form-row form-group-inline align-items-center mb-3', form_control_container_custom_class: 'col-7 pr-0'} %}
							...
							{% block input_form_alert %}
								...
								<div class="col-12">
									<div
										class="js-ship-calculator-error invalid-zipcode alert alert-danger" style="display: none;">
