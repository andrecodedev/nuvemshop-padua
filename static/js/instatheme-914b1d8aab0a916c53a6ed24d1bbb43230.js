  ...
  return {
      ...
      return [
        ...
        },
        {
          ...
          contentReady: function () {
            ...
            return (
              $(this).find('.js-testimonial-container').text().trim() ||
              $(this)
                .find('.js-testimonial-img')
                .map(function () {
        ...
        },
        {
          ...
          contentReady: function () {
            ...
            return (
              $(this).find('.js-informative-banner-title').text().trim() ||
              $(this)
                .find('.js-informative-banner-description')
                .text()
                .trim() ||
              $(this)
                .find('.js-informative-banner-img')
                .map(function () {
                  return $(this).attr('src');
                })
                .get()
          ...
          contentReady: function () {
            ...
            return (
              ...
              $(this)
                ...
                .trim() ||
              $(this)
                .find('.js-timer-offers-image-mobile')
                .map(function () {
                  return $(this).attr('src');
                })
                .get()
    ...
    handlers: function (instaElements) {
      ...
      ['adbar_primary', 'adbar_secondary'].forEach((setting) => {
        ...
        const $adBarMessageContainer = $adBar.find(
          '.js-adbar-message-container',
        );
        const $adBarImagesContainer = $adBar.find('.js-adbar-img-container');

        // Toggle adbar visibility
        handlers[`${setting}`] = new instaElements.Lambda(function (
          adbarVisible,
        ) {
        ...
        // Toggle adbar colors
        handlers[`${setting}_colors`] = new instaElements.Lambda(function (
          adbarColors,
        ) {
          if (adbarColors) {
        ...
        if (setting == 'adbar_primary') {
          ...
          handlers[`${setting}_img_desktop.jpg`] = new instaElements.Image({
            ...
            show: function () {
              ...
              $adBar
                .addClass('adbar-with-image')
                .attr('data-image-desktop', 'true');
            ...
            hide: function () {
              ...
              if (hasMobileImage == 'false') {
                ...
                $adBarImagesContainer.removeClass(
                  'adbar-img-container adbar-with-messages',
                );
              }
              ...
              if (messagesAmount >= 1) {
                ...
                if (adbarActive == 'true') {
                  if (hasMobileImage == 'true') {
                    ...
                    $adBar
                      .hide()
                      .removeClass('d-block d-md-block')
                      .addClass('d-none d-md-none');
                  }
                }
              }
            },
      ...
      setDesktopNavWidth = function (remainingSibling, remainingSiblingWidth) {
        if (window.innerWidth > 768) {
          ...
          const mainNavContainerWidth = $(
            '.js-nav-desktop-container',
          ).outerWidth();
          const menuNavListWidth = $('.js-nav-desktop-list').outerWidth();
          let mainCategoriesContainerWidth = $(
            '.js-desktop-main-categories-col',
          ).is(':visible')
            ? $('.js-desktop-main-categories-col').outerWidth()
            : 0;
          let secondaryNavContainerWidth = $(
            '.js-desktop-secondary-nav-col',
          ).is(':visible')
            ? $('.js-desktop-secondary-nav-col').outerWidth()
            : 0;
          const totalColsWidth =
            mainCategoriesContainerWidth + secondaryNavContainerWidth;

          // Set main nav fixed width
          const menuColWidth = mainNavContainerWidth - totalColsWidth;

          // Check if main nav has siblings
          const navHasSiblings = $(
            '.js-desktop-main-categories-col, .js-desktop-secondary-nav-col',
          ).is(':visible');
          ...
          if (menuNavListWidth < menuItemsWidth) {
            ...
            if (navHasSiblings) {
              ...
              if (remainingSibling) {
                const menuColUpdatedWidth =
                  mainNavContainerWidth - remainingSiblingWidth;
                const remainingSiblingUpdatedWidth =
                  mainNavContainerWidth - menuColUpdatedWidth;
      ...
      handlers.logo_position_mobile = new instaElements.Lambda(function (
        logoMobile,
      ) {
        if (logoMobile == 'left') {
      ...
      handlers.logo_position_desktop = new instaElements.Lambda(function (
        logoDesktop,
      ) {
        const $logoImage = $('.js-logo-container').find('img');
        const $logoContainer = $('.js-logo-container');
      ...
      handlers.header_colors = new instaElements.Lambda(function (
        headerColors,
      ) {
      ...
      handlers.desktop_nav_colors = new instaElements.Lambda(function (
        desktopNavColors,
      ) {
      ...
      handlers.featured_link_url = new instaElements.Lambda(function (
        featuredLink,
      ) {
        const featuredLinkUrlInstatheme = featuredLink
          .split('://')
          .pop()
          .split('/')
          .slice(1)
        ...
        $('.js-nav-list-link').each(function () {
          ...
          if (featuredLink && linkUrl == featuredLinkUrlInstatheme) {
            ...
            $(this).removeClass(
              'js-nav-list-link-featured nav-list-link-featured nav-list-link-featured-color',
            );
        ...
        if ($('.js-nav-list-link-featured').length) {
          $('.js-nav-desktop')
            .attr('data-featured-link', 'true')
            .attr('data-featured-link', 'true')
            .attr('data-featured-link-url', featuredLinkUrlInstatheme);
        } else {
          $('.js-nav-desktop')
            .attr('data-featured-link', 'false')
            .attr('data-featured-link', 'false')
            .attr('data-featured-link-url', '');
        }
      });

      // Update desktop featured nav colors
      handlers.featured_link_color = new instaElements.Lambda(function (
        featuredLinkColor,
      ) {
        const featuredLinkActive =
          $('.js-nav-desktop').attr('data-featured-link');
      ...
      handlers.head_fix_desktop = new instaElements.Lambda(function (headFix) {
        ...
        if (window.innerWidth > 768) {
          if (headFix) {
            $head
              .addClass('position-sticky-md')
              .removeClass('position-relative-md');
            $head.attr('data-header-md-fixed', 'true');
          } else {
            $head
              .removeClass('position-sticky-md')
              .addClass('position-relative-md');
      ...
      handlers.utilities_type_desktop = new instaElements.Lambda(function (
        utilitiesTypeDesktop,
      ) {
        ...
        const $utilityLanguageSecondaryNavContainer = $(
          '.js-desktop-secondary-nav-col',
        );
        const $utilityLanguageSecondaryNav = $(
          '.js-desktop-secondary-nav-col .js-utility-account-desktop',
        );
        const secondaryNavContainerVisibility = $mainNavContainer.attr(
          'data-desktop-nav-secondary-or-language',
        );
        const secondaryNavVisibility = $mainNavContainer.attr(
          'data-desktop-nav-secondary',
        );
        const mainCategoriesVisibility = $mainNavContainer.attr(
          'data-desktop-main-categories',
        );
        ...
        if (utilitiesTypeDesktop == 'icons_text') {
          ...
          if (secondaryNavVisibility == 'false') {
            ...
            $mainNavContainer.removeClass(
              'nav-desktop-grid-secondary-nav-only',
            );
          } else {
            $mainNavContainer.attr(
              'data-desktop-nav-secondary-or-language',
          ...
          if (
            secondaryNavVisibility == 'false' &&
            mainCategoriesVisibility == 'false'
          ) {
      ...
      handlers.desktop_utility_colors = new instaElements.Lambda(function (
        utilitiesColorsDesktop,
      ) {
      ...
      handlers.utilities_cart_icon = new instaElements.Lambda(function (
        utilitiesCartIcon,
      ) {
      ...
      handlers.desktop_main_nav_uppercase = new instaElements.Lambda(function (
        navUppercase,
      ) {
        const $navUppercaseTarget = $(
      ...
      handlers.category_item = new instaElements.Lambda(function (
        ...
        if (window.innerWidth > 768) {
          if (mainCategoriesDesktop) {
            $mainNavContainer
              .addClass('nav-desktop-grid')
              .removeClass('nav-desktop-grid-secondary-nav-only');
            ...
            if (secondaryNavContainerVisibility == 'false') {
              ...
              $mainNavContainer.addClass(
                'nav-desktop-grid nav-desktop-grid-secondary-nav-only',
              );
            }
            const mainCategoriesContainerWidth = $(
              '.js-desktop-main-categories-col',
            ).outerWidth();
            const secondaryNavWidth = $(
              '.js-desktop-secondary-nav-col',
            ).width();
      ...
      handlers.head_main_categories = new instaElements.Lambda(function (
      ...
      handlers.footer_colors = new instaElements.Lambda(function (
        footerColors,
      ) {
      ...
      handlers.footer_menu_title = new instaElements.Text({
        ...
        show: function () {
          ...
          if (window.innerWidth < 768) {
            $(this)
              .closest('.js-accordion-private-container')
              .find('.js-accordion-private-content-mobile')
              .hide();
          }
        },
        hide: function () {
      ...
      function buildHomeSlideDom(aSlide, index, length, alignClasses) {
        return (
          ...
          aSlide.src +
          '" class="slider-image"/>' +
          (aSlide.description || aSlide.title
          ...
          '">' +
          (aSlide.title
            ? '<div class="h1 my-2">' + aSlide.title + '</div>'
            : '') +
          (aSlide.description
            ? '<div class="mt-2 mb-3">' + aSlide.description + '</div>'
            : '') +
          (aSlide.button && aSlide.link
            ? '<div class="btn btn-primary">' + aSlide.button + '</div>'
            : '') +
          '</div>' +
          (aSlide.link ? '</a>' : '') +
          '</div>'
      ...
      handlers.slider = new instaElements.Lambda(function (slides) {
        ...
        const alignClasses =
          sliderAlign == 'center' ? 'swiper-text-centered' : '';

        window.homeSwiper.removeAllSlides();
        slides.forEach(function (aSlide, index, array) {
          window.homeSwiper.appendSlide(
            buildHomeSlideDom(aSlide, index, array.length, alignClasses),
          );
        });
      });
      ...
      handlers.slider_mobile = new instaElements.Lambda(function (slides) {
        ...
        slides.forEach(function (aSlide, index, array) {
          window.homeMobileSwiper.appendSlide(
            buildHomeSlideDom(aSlide, index, array.length, alignClasses),
          );
        });
      });
      ...
      handlers.slider_full = new instaElements.Lambda(function (sliderFull) {
        ...
        const $swiperArrows = $swiperContainer.find(
          '.js-swiper-home-prev, .js-swiper-home-next',
        );

        if (sliderFull) {
          $swiperContainer
            .removeClass('container')
            .addClass('swiper-arrows-light');
          ...
          $swiperContainer
            .removeClass('swiper-arrows-light')
            .addClass('container');
      ...
      function buildHomeBannerDom(
        ...
        slideCount++;
        var evenClass =
          slideCount % 2 === 0 ? 'js-banner-even order-md-first ' : '';
        return (
          '<div class="js-banner-item ' +
          bannerClasses +
          '">' +
          '<div class="js-textbanner textbanner ' +
          (bannerModule && !aSlide.link
            ? ' js-module-grid grid grid-md-2 grid-no-gap align-items-center mb-md-5 overflow-none '
            : ' ') +
          textBannerClasses +
          '">' +
          (aSlide.link
          ...
          '<img src="' +
          aSlide.src +
          '" class="textbanner-image transition-soft img-fluid d-block w-100"/>' +
          '<div class="js-textbanner-text textbanner-text ' +
          (bannerModule
            ? 'textbanner-text-background textbanner-text-centered-content h-100 p-3 p-md-4 text-center ' +
              evenClass
            : ' ') +
          textClasses +
          ' text-' +
          ...
          '">' +
          (aSlide.title
            ? '<div class="h2 my-2">' + aSlide.title + '</div>'
            : '') +
          (aSlide.description
            ? '<div class="textbanner-paragraph mt-2">' +
              aSlide.description +
              '</div>'
            : '') +
          (aSlide.button && aSlide.link
            ? '<div class="btn btn-primary mt-3">' + aSlide.button + '</div>'
            : '') +
          '</div>' +
          (aSlide.link ? '</a>' : '') +
          '</div>' +
      ...
      function initSwiperJS(
        ...
        const swiperDesktopColumns = isModule
          ? 1
          : bannerMainContainer.attr('data-desktop-columns');
      ...
      ['banner', 'banner_promotional', 'banner_news', 'module'].forEach(
        (setting) => {
          const bannerName =
            setting == 'banner'
              ? 'banner'
              : setting == 'banner_promotional'
              ? 'banner-promotional'
              : setting == 'banner_news'
              ? 'banner-news'
              : setting == 'module'
          ...
          // Main banner
          const $mainBannersContainer = $generalBannersContainer.find(
            `.js-${bannerName}`,
          );
          ...
          const bannerMobileName =
            setting == 'banner'
              ? 'banner-mobile'
              : setting == 'banner_promotional'
              ? 'banner-promotional-mobile'
              : setting == 'banner_news'
              ? 'banner-news-mobile'
              : null;
          const $mobileBannersContainer = $generalBannersContainer.find(
            `.js-${bannerMobileName}`,
          );
          ...
          const bannerSwiper =
            setting == 'banner'
              ? 'homeBannerSwiper'
              : setting == 'banner_promotional'
              ? 'homeBannerPromotionalSwiper'
              : setting == 'banner_news'
              ? 'homeBannerNewsSwiper'
              : setting == 'module'
              ? 'homeModuleSwiper'
              : null;
          ...
          const bannerSwiperMobile =
            setting == 'banner'
              ...
              : setting == 'banner_promotional'
              ? 'homeBannerPromotionalMobileSwiper'
              : setting == 'banner_news'
              ? 'homeBannerNewsMobileSwiper'
              : null;

          const bannerModuleSetting = setting == 'module' ? true : false;
          const $bannerMainItem =
            $generalBannersContainer.find('.js-banner-item');

          const desktopFormat = $generalBannersContainer.attr(
            'data-desktop-format',
          );
          const mobileFormat =
            $generalBannersContainer.attr('data-mobile-format');

          const desktopColumns = $generalBannersContainer.attr(
          ...
          handlers[`${setting}`] = new instaElements.Lambda(function (slides) {
            ...
            const positionClasses =
              textPosition == 'above'
                ? 'textbanner-text-above'
                : 'textbanner-text-background';
            ...
            const alignClasses =
              bannerAlign == 'center'
                ? 'text-center textbanner-text-center'
                : '';
            ...
            const desktopColumnsClasses =
              $generalBannersContainer.attr('data-grid-classes');
            ...
            function instaSlider() {
              ...
              try {
                ...
                slides.forEach(function (aSlide) {
                  window[bannerSwiper].appendSlide(
                    buildHomeBannerDom(
                      aSlide,
                      bannerClasses,
                      textBannerClasses,
          ...
          function initSwiperElements(
            ...
            const swiperDesktopColumns = $generalBannersContainer.attr(
              'data-desktop-columns',
            );
            const swiperArrowDisplayClasses =
              mobileFormat == 'slider' && desktopFormat == 'grid'
                ? 'd-none'
                : 'd-none d-md-block';
            const swiperArrowPostionClasses =
              bannerMargin == 'false'
                ? 'svg-icon-invert'
                : 'swiper-button-outside svg-icon-text';
            const swiperArrowClasses =
              swiperArrowDisplayClasses + ' ' + swiperArrowPostionClasses;
            ...
            bannerRow.wrapAll(
              `<div class="js-swiper-${swiperId} swiper-container"></div>`,
            );
          ...
          function resetSwiperElements(
            ...
            const $bannerItem =
              $generalBannersContainer.find('.js-banner-item');
            const $bannerText =
              $generalBannersContainer.find('.js-module-grid');
            const $bannerTextEven =
              $generalBannersContainer.find('.js-banner-even');
            const desktopColumnsClasses =
              $generalBannersContainer.attr('data-grid-classes');
            ...
            $mainBannersContainer
              .find(
                `.js-swiper-${swiperId}-pagination, .js-swiper-${swiperId}-prev, .js-swiper-${swiperId}-next, .swiper-slide-duplicate`,
              )
              .remove();
            ...
            $bannerItem
              .removeClass(
                'js-swiper-slide-visible swiper-slide-active swiper-slide-next swiper-slide-prev swiper-slide',
              )
              .removeAttr('style');
          }
          ...
          handlers[`module_slider`] = new instaElements.Lambda(function (
            moduleSlider,
          ) {
            // Main banners markup container
            const $bannerContainer = $generalBannersContainer.find(
              '.js-banner-container',
            );
            const $bannerGrid =
              $generalBannersContainer.find('.js-banner-grid');
            const $mainBanner =
              $generalBannersContainer.find('.js-module-grid');
            const $mainBannerText = $generalBannersContainer.find(
              '.js-textbanner-text',
            );
          ...
          if (!isModule) {
            ...
            if (desktopFormat == 'slider' && mobileFormat == 'slider') {
              const $bannerGrid =
                $generalBannersContainer.find('.js-banner-grid');
              $bannerGrid.removeClass(
                'grid grid-md-4 grid-md-3 grid-md-2 grid-md-1',
              );
            }
            ...
            if (desktopFormat == 'grid') {
              $mainBannersContainer
                .find(`.js-swiper-${bannerName}-prev`)
                .removeClass('d-md-block');
              $mainBannersContainer
                .find(`.js-swiper-${bannerName}-next`)
                .removeClass('d-md-block');

              $mobileBannersContainer
                .find(`.js-swiper-${bannerMobileName}-prev`)
                .removeClass('d-md-block');
              $mobileBannersContainer
                .find(`.js-swiper-${bannerMobileName}-next`)
                .removeClass('d-md-block');
            }

            // Toggle grid and slider mobile view
            handlers[`${setting}_format_mobile`] = new instaElements.Lambda(
              function (bannerFormat) {
                ...
                const $bannerGrid =
                  $generalBannersContainer.find('.js-banner-grid');
                const $mainBannerGrid =
                  $mainBannersContainer.find('.js-banner-grid');
                const $bannerMobileGrid =
                  $mobileBannersContainer.find('.js-banner-grid');
                ...
                if (toSlider) {
                  ...
                  if (
                    $generalBannersContainer.find('.swiper-slide').length < 1
                  ) {
                    $generalBannersContainer
                      .find(`.js-swiper-${bannerMobileName}-pagination`)
                      .removeClass('d-none')
                      .addClass('d-block');
                    initSwiperElements(
                      $mainBannerGrid,
                  ...
                  if (desktopFormat == 'grid') {
                    ...
                    $bannerGrid
                      .removeClass(
                        'swiper-mobile-only flex-md-wrap transform-none grid',
                      )
                      .addClass('swiper-products-slider flex-nowrap');
                    if (window.innerWidth < 768) {
                      $bannerItem
                        .removeClass('m-0 w-100')
                  ...
                  if (desktopFormat == 'slider') {
                    ...
                    $bannerGrid
                      .removeClass('swiper-products-slider flex-nowrap')
                      .addClass(
                        'swiper-desktop-only flex-wrap flex-md-nowrap ml-md-0 grid',
                      );
                    if (window.innerWidth < 768) {
                      $bannerGrid.addClass('transform-none');
                      ...
                      $mainBannersContainer
                        .find(
                          `.js-swiper-${bannerName}-pagination, .js-swiper-${bannerName}-prev, .js-swiper-${bannerName}-next`,
                        )
                        .remove();
                      $mobileBannersContainer
                        .find(
                          `.js-swiper-${bannerMobileName}-pagination, .js-swiper-${bannerMobileName}-prev, .js-swiper-${bannerMobileName}-next`,
                        )
                        .remove();
                    ...
                    $bannerGrid
                      .removeClass(
                        'swiper-wrapper swiper-mobile-only flex-nowrap flex-md-wrap transform-none',
                      )
                      .removeAttr('style');
                    if (desktopFormat == 'grid' && mobileFormat == 'grid') {
                      $bannerGrid.removeClass(
                        'swiper-wrapper swiper-desktop-only flex-wrap flex-md-nowrap ml-md-0 transform-none',
                      );
                    }
                  }
                }
            ...
            handlers[`${setting}_format_desktop`] = new instaElements.Lambda(
              function (bannerFormat) {
                const toSlider = bannerFormat == 'slider';
                ...
                if (
                  $generalBannersContainer.attr('data-desktop-format') ==
                  bannerFormat
                ) {
                  // Nothing to do
                  return;
                ...
                if (toSlider) {
                  ...
                  if (mobileFormat == 'grid') {
                    ...
                    $bannerGrid
                      ...
                      .addClass('swiper-products-slider');
                  ...
                  if (mobileFormat == 'slider') {
                    // Mantain mobile slider
                    $bannerGrid
                      .removeClass('swiper-products-slider')
                      .addClass(
                        'swiper-mobile-only flex-nowrap flex-md-wrap grid ' +
                          desktopColumnsClasses,
                      );
                    if (window.innerWidth > 768) {
                      $bannerGrid.addClass('transform-none');
                      $bannerItem.removeAttr('style');
            ...
            handlers[`${setting}_text_outside`] = new instaElements.Lambda(
              function (hasOutsideText) {
                const $bannerText = $generalBannersContainer.find(
                  '.js-textbanner-text',
                );
                ...
                if (hasOutsideText) {
                  ...
                  $bannerText
                    .removeClass('textbanner-text-above')
                    .addClass('textbanner-text-background');
                } else {
                  $generalBannersContainer.attr('data-text', 'above');
                  $bannerText
                    .removeClass('textbanner-text-background')
                    .addClass('textbanner-text-above');
                }
              },
            );

            // Update banner text align
            handlers[`${setting}_align`] = new instaElements.Lambda(function (
              bannerAlign,
            ) {
              const $bannerText = $generalBannersContainer.find(
                '.js-textbanner-text',
            ...
            handlers[`${setting}_without_margins`] = new instaElements.Lambda(
              function (bannerMargin) {
                ...
                const mobileFormat =
                  $generalBannersContainer.attr('data-mobile-format');
                const $bannerSection = $generalBannersContainer.closest(
                ...
                const $bannerItem =
                  $generalBannersContainer.find('.js-textbanner');
                const $bannerArrows = $(
                  `.js-swiper-${bannerName}-prev, .js-swiper-${bannerName}-next`,
                );

                if (bannerMargin) {
                  $bannerSection.addClass('p-0').removeClass('py-4');
                  $bannerContainer
                    .removeClass('container px-md-3')
                    .addClass('container-fluid overflow-none p-0');
                  $bannerGrid.addClass('grid-no-gap');
                  $bannerItem.addClass('m-0');
                  $bannerArrows
                    .removeClass('swiper-button-outside svg-icon-text')
                    .addClass('svg-icon-invert');
                  if (
                    (desktopFormat == 'slider' && window.innerWidth > 768) ||
                    (mobileFormat == 'slider' && window.innerWidth < 768)
                  ) {
                  ...
                  $bannerContainer
                    .removeClass('container-fluid overflow-none p-0')
                    .addClass('container px-md-3');
                  $bannerGrid.removeClass('grid-no-gap');
                  $bannerItem.removeClass('m-0');
                  $bannerArrows
                    .removeClass('svg-icon-invert')
                    .addClass('swiper-button-outside svg-icon-text');
                  if (
                    (desktopFormat == 'slider' && window.innerWidth > 768) ||
                    (mobileFormat == 'slider' && window.innerWidth < 768)
                  ) {
            ...
            handlers[`${setting}_columns_desktop`] = new instaElements.Lambda(
              function (bannerQuantity) {
                ...
                $bannerGrid.removeClass(
                  'grid-md-4 grid-md-3 grid-md-2 grid-md-1',
                );
                if (bannerQuantity == 4) {
                  $generalBannersContainer.attr(
                    'data-desktop-columns',
            ...
            handlers[`toggle_${setting}_mobile`] = new instaElements.Lambda(
              function (showMobileBanner) {
                ...
                $mainBannersContainer.removeClass(
                  'hidden d-md-none d-none d-md-block',
                );
                $mobileBannersContainer.removeClass(
                  'hidden d-md-none d-none d-md-block',
                );
      ...
      [
        'banner_mobile',
        'banner_promotional_mobile',
        'banner_news_mobile',
      ].forEach((setting) => {
        const bannerName = setting.replace('_', '-').replace(/[-_]mobile$/, '');
        const bannerMobileName =
          setting == 'banner_mobile'
            ? 'banner-mobile'
            : setting == 'banner_promotional_mobile'
            ? 'banner-promotional-mobile'
            : setting == 'banner_news_mobile'
            ? 'banner-news-mobile'
            : null;
        const $generalBannersContainer = $(`.js-home-${bannerName}`);
        ...
        handlers[`${setting}`] = new instaElements.Lambda(function (slides) {
          ...
          const bannerAlign = $generalBannersContainer.attr('data-align');
          const alignClasses =
            bannerAlign == 'center' ? 'text-center textbanner-text-center' : '';
          ...
          function instaSlider() {
            ...
            try {
              ...
              slides.forEach(function (aSlide) {
                window[bannerSwiperMobile].appendSlide(
                  buildHomeBannerDom(
                    aSlide,
                    bannerClasses,
                    textBannerClasses,
      ...
      function institutionalContentVisibility(container) {
        ...
        const hasContent =
          $(container).find('.js-institutional-title').text().trim() ||
      ...
      for (let i = 1; i <= 4; i++) {
        ...
        ['title', 'description', 'button'].forEach((setting) => {
          handlers[`institutional_0${i}_${setting}`] = new instaElements.Text({
            ...
            show: function () {
              $(this).show();
              institutionalContentVisibility(
                $(this).closest('.js-institutional-slide'),
              );
            },
            hide: function () {
              $(this).hide();
      ...
      handlers.home_institutional_colors = new instaElements.Lambda(function (
        institutionalColors,
      ) {
        ...
        if (institutionalColors) {
          $container
            .addClass('section-institutional-home-colors py-5')
            .removeClass('py-4');
        } else {
          $container
            .removeClass('section-institutional-home-colors py-5')
            .addClass('py-4');
        }
      });
      ...
      function buildMainCategoriesSlideDom(aSlide) {
        return (
          '<div class="js-main-category-slide swiper-slide w-auto mr-4">' +
          (aSlide.link
            ? '<a href="' + aSlide.link + '" class="js-home-category-live">'
            : '') +
          '<div class="home-category">' +
          '<div class="js-home-category-image home-category-image">' +
          '<img src="' +
          aSlide.src +
          '" class="swiper-lazy d-block img-fluid"/>' +
          '</div>' +
      ...
      handlers.slider_categories = new instaElements.Lambda(function (slides) {
        ...
        slides.forEach(function (aSlide) {
          window.mainCategoriesSwiper.appendSlide(
            buildMainCategoriesSlideDom(aSlide),
          );
        });
      });

      // Update main categories image border
      handlers.main_categories_border = new instaElements.Lambda(function (
        borderImage,
      ) {
      ...
      handlers.video_embed = new instaElements.Lambda(function (videoUrl) {
        ...
        $container
          .closest('.js-home-video-container')
      ...
      // Video colors
      handlers.home_video_colors = new instaElements.Lambda(function (
        videoColors,
      ) {
      ...
      handlers.video_vertical_mobile = new instaElements.Lambda(function (
        isFullwidth,
      ) {
        const $container = $('.js-home-video');
        if (isFullwidth) {
      ...
      function videoContentVisibility(container) {
        const hasContent =
          $(container).find('.js-home-video-title').text().trim() ||
          $(container).find('.js-home-video-text').text().trim() ||
          $(container).find('.js-home-video-button').text().trim();
        if (hasContent) {
          $(container).show();
          $('.js-home-video-container').removeClass(
            'home-background-container-full',
          );
        } else {
          $(container).hide();
          $('.js-home-video-container').addClass(
            'home-background-container-full',
          );
        }
      }
        ...
        handlers[`video_${setting}`] = new instaElements.Text({
          ...
          show: function () {
            ...
            videoContentVisibility(
              $(this).closest('.js-home-video-text-container'),
            );
          },
          hide: function () {
            $(this).hide();
      ...
      handlers.testimonials_title = new instaElements.Lambda(function (
        testimonialsTitle,
      ) {
        const $testimonialsTitle = $('.js-testimonial-main-title');
        const $testimonialsTitleContainer = $(
          '.js-testimonial-main-title',
        ).parent();
      ...
      function testimonialContentVisibility(container) {
        const hasContent =
          $(container).find('.js-testimonial-description').text().trim() ||
      ...
      for (let i = 1; i <= 5; i++) {
        ...
        handlers[`testimonial_0${i}.jpg`] = new instaElements.Image({
          ...
          show: function () {
            ...
            testimonialContentVisibility(
              $(this).closest(
                '.js-section-testimonials, .js-testimonial-slide',
              ),
            );
          },
          hide: function () {
        ...
        ['name', 'title', 'description'].forEach((setting) => {
          handlers[`testimonial_0${i}_${setting}`] = new instaElements.Text({
            ...
            show: function () {
              $(this).show();
              testimonialContentVisibility(
                $(this).closest('.js-testimonial-slide'),
              );
            },
            hide: function () {
              $(this).hide();
        ...
        handlers[`testimonial_0${i}_stars`] = new instaElements.Lambda(
          function (testimonialStars) {
            const $itemStars = $(`.js-testimonial-stars-${i}`);

            $itemStars.removeClass(
              'testimonial-stars-1 testimonial-stars-2 testimonial-stars-3 testimonial-stars-4 testimonial-stars-5',
            );
      ...
      function newsletterContentVisibility(container) {
        const hasContent =
          $(container).find('.js-home-newsletter-title').text().trim() ||
        ...
        if (hasContent) {
          $(container).show();
          $('.js-home-newsletter-container').removeClass(
            'home-background-container-center',
          );
        } else {
          $(container).hide();
          $('.js-home-newsletter-container').addClass(
            'home-background-container-center',
          );
        }
      }
        ...
        handlers[`home_news_${setting}.jpg`] = new instaElements.Image({
          ...
          show: function () {
            ...
            if ($('.js-home-newsletter-image').css('display') !== 'none') {
              $('.js-home-newsletter-image-mobile').addClass(
                'd-block d-md-none',
              );
            } else {
              $('.js-home-newsletter-image-mobile').removeClass(
                'd-block d-md-none',
              );
            }
            // Hides desktop image if has mobile image
            if (
              $('.js-home-newsletter-image-mobile').css('display') !== 'none'
            ) {
            ...
            // Maybe show container now that there's content inside
            newsletterContentVisibility(
              $(this).closest('.js-home-newsletter-image-container'),
            );
          },
          hide: function () {
            $(this).hide();
      ...
      // Newsletter colors
      handlers.home_news_colors = new instaElements.Lambda(function (
        newsColors,
      ) {
        ...
        handlers[`timer_offers_${setting}.jpg`] = new instaElements.Image({
          ...
          show: function () {
            ...
            if ($('.js-timer-offers-image').css('display') !== 'none') {
              ...
              $('.js-timer-offers-image-mobile').removeClass(
                'd-block d-md-none',
              );
            }
            // Hides desktop image if has mobile image
            if ($('.js-timer-offers-image-mobile').css('display') !== 'none') {
              ...
              $('.js-timer-offers-image-image').removeClass(
                'd-none d-md-block',
              );
            }
          ...
          hide: function () {
            ...
            $(
              '.js-timer-offers-image ,.js-timer-offers-image-mobile',
            ).removeClass('d-none d-block d-md-block d-md-none');
            if (
              $('.js-timer-offers-image').css('display') === 'none' &&
              $('.js-timer-offers-image-mobile').css('display') === 'none'
            ) {
              $('.js-timer-offers-content')
                .removeClass('py-5')
                .addClass('py-3');
            }
          },
      ...
      // Toggle full-width
      handlers.timer_offers_full = new instaElements.Lambda(function (
        isFullwidth,
      ) {
      ...
      handlers.timer_offers_align = new instaElements.Lambda(function (
        alignContent,
      ) {
      ...
      // Timer offer colors
      handlers.timer_offers_colors = new instaElements.Lambda(function (
        timerOffersColors,
      ) {
      ...
      handlers.timer_offers_products_show = new instaElements.Lambda(function (
        showOfferProducts,
      ) {
        const $container = $('.js-timer-offers-container');
      ...
      ['featured', 'sale', 'new'].forEach((setting) => {
        ...
        handlers[`${setting}_products_desktop`] = new instaElements.Lambda(
          function (desktopProductQuantity) {
        ...
        handlers[`${setting}_products_mobile`] = new instaElements.Lambda(
          function (mobileProductQuantity) {
        ...
        function initSwiperElements() {
          ...
          // Wrap everything inside a swiper container
          $productGrid.wrapAll(
            `<div class="js-swiper-${setting} swiper-container"></div>`,
          );
        ...
        // Reset swiper function
        function resetSwiperElements() {
          const desktopProductQuantity = $productGrid.attr(
            'data-desktop-columns',
          );
          const mobileProductQuantity = $productGrid.attr(
            'data-mobile-columns',
          );

          const desktopColumnsClasses =
            desktopProductQuantity == '4'
              ? 'grid-md-4'
              : desktopProductQuantity == '5'
              ? 'grid-md-5'
              : 'grid-md-6';
          const mobileColumnsClasses =
            mobileProductQuantity == '2' ? 'grid-2' : 'grid-1';
          const columnClasses =
            desktopColumnsClasses + ' ' + mobileColumnsClasses;
          ...
          if ($productItem.hasClass('js-item-slide')) {
            $productGrid.unwrap();
            $productItem
              .removeClass('js-item-slide swiper-slide')
              .removeAttr('style');
          } else {
            $productGrid.unwrap();
            $productItem.unwrap();
        ...
        // Toggle grid and slider mobile view
        handlers[`${setting}_products_format_mobile`] =
          new instaElements.Lambda(function (format) {
            ...
            if (toSlider) {
              ...
              if (desktopFormat == 'slider') {
                $productGrid.removeClass(
                  'swiper-desktop-only flex-wrap flex-md-nowrap ml-md-0 swiper-mobile-only flex-nowrap flex-md-wrap transform-none grid',
                );
                $productContainer
                  .find(`.js-swiper-${setting}-pagination`)
                  .removeClass('d-none');
                if (window.innerWidth < 768) {
                  initSwiper();
                }
              ...
              if (desktopFormat == 'slider') {
                ...
                $productGrid
                  .removeClass('swiper-products-slider')
                  .addClass(
                    `swiper-desktop-only flex-wrap flex-md-nowrap ml-md-0 grid grid-${mobileColumns} grid-md-${desktopColumns}`,
                  );
                if (window.innerWidth < 768) {
                  $productGrid.addClass('transform-none');
                  $productContainer
                  ...
                  $productContainer
                    .find(
                      `.js-swiper-${setting}-prev, .js-swiper-${setting}-next`,
                    )
                    .addClass('d-none');
                  $productGrid.find('.swiper-slide-duplicate').remove();
        ...
        // Toggle grid and slider desktop view
        handlers[`${setting}_products_format_desktop`] =
          new instaElements.Lambda(function (format) {
            const toSlider = format == 'slider';
            ...
            if (toSlider) {
              ...
              $productContainer
                .find(`.js-swiper-${setting}-prev, .js-swiper-${setting}-next`)
              ...
              if (mobileFormat == 'slider') {
                ...
                $productGrid
                  .removeClass('swiper-products-slider')
                  .addClass(
                    `swiper-mobile-only flex-nowrap flex-md-wrap grid grid-${mobileColumns} grid-md-${desktopColumns}`,
                  );
                if (window.innerWidth > 768) {
                  $productGrid.addClass('transform-none');
                  $productContainer
      ...
      function informativeContentVisibility(container) {
        const hasContent =
          $(container).find('.js-informative-banner-title').text().trim() ||
      ...
      handlers.banner_services_colors = new instaElements.Lambda(function (
        sectionColor,
      ) {
      ...
      for (let i = 1; i <= 4; i++) {
        // Add html for image
        $(`.js-informative-banner-icon-${i}`)
          .closest('.js-informative-banner-container')
          .prepend(
            `<img class="js-informative-banner-img js-informative-banner-img-${i} service-item-image mb-3" style="display:none;"></img>`,
          );

        // Add html for icon
        if ($(`.js-informative-banner-img-${i}`).attr('src')) {
          $(`.js-informative-banner-img-${i}`)
            .closest('.js-informative-banner-container')
            .prepend(
              `<div class="js-informative-banner-icon-${i} mb-3" style="display:none;"><svg class="icon-inline icon-2x svg-icon-text"><use xlink:href=""/></svg></div>`,
            );
        }

        // Update icon for each informative banner
        handlers[`banner_services_0${i}_icon`] = new instaElements.Lambda(
          function (iconCode) {
            ...
            $(`.js-informative-banner-icon-${i} svg use`).attr(
              'xlink:href',
              informativeBannersIconMap[iconCode],
            );
          },
        );
        ...
        handlers[`banner_services_0${i}.jpg`] = new instaElements.Image({
          ...
          show: function () {
            if (
              $(`.js-informative-banner-icon-${i}`).css('display') === 'none'
            ) {
              $(`.js-informative-banner-img-${i}`).show();
              $(`.js-informative-banner-icon-${i}`).hide();
            }
