...
{% set has_banner_full = settings.banner_full and settings.banner_full is not empty %}
...
{% set show_help = not (has_main_slider or has_mobile_slider or has_informative_banners or has_category_banners or has_banner_full or has_brands or has_video or has_instafeed or has_promotional_banners) and not has_products and not params.preview %}
...
<div class="js-home-sections-container">
	...
	{% if show_component_help %}
		<div style="display:none">
			{% for section_select in ['slider', 'welcome', 'products', 'informatives', 'categories', 'promotional', 'banner_full', 'brands', 'new', 'video', 'sale', 'instafeed', 'newsletter'] %}
				{% if section_select not in newArray %}
					{% include 'snipplets/home/home-section-switch.tpl' %}
				{% endif %}
			{% endfor %}
